...
public class DoctorController implements PmsController {
              ...
              @Content(
                  ...
                  examples = {
                    @ExampleObject(
                        ...
                        description =
                            "A bad request response example when trying to register a doctor",
              ...
              @Content(
                  ...
                  examples = {
                    @ExampleObject(
                        ...
                        description =
                            "A internal server error response example when trying to register a doctor",
                        value = EXAMPLE_ERROR_500_INTERNAL_SERVER_ERROR)
                  })
            })
      })
  @PostMapping
  public ResponseEntity<DoctorResponse> insert(@RequestBody @Valid @NotNull DoctorRequest request) {
              ...
              @Content(
                  ...
                  examples = {
                    @ExampleObject(
                        name = EXAMPLE_BAD_REQUEST_NAME,
                        description =
                            "A bad request response example when trying to update a doctor",
                        value = DOCTOR_EXAMPLE_ERROR_400_BAD_REQUEST)
                  })
            }),
        @ApiResponse(
              ...
              @Content(
                  ...
                  examples = {
                    @ExampleObject(
                        ...
                        description =
                            "A not found response example when trying to update a doctor does not exist",
              ...
              @Content(
                  ...
                  examples = {
                    @ExampleObject(
                        name = EXAMPLE_INTERNAL_SERVER_ERROR_NAME,
                        description =
                            "A internal server error response example when trying to update a doctor",
                        value = EXAMPLE_ERROR_500_INTERNAL_SERVER_ERROR)
                  })
            })
      })
  ...
  public ResponseEntity<Void> update(
      @PathVariable Long id, @RequestBody @Valid @NotNull DoctorRequest request) {
              ...
              @Content(
                  ...
                  examples = {
                    @ExampleObject(
                        name = EXAMPLE_NOT_FOUND_NAME,
                        description =
                            "A not found response example when trying to retrieve a doctor does not exist",
                        value = DOCTOR_EXAMPLE_ERROR_404_NOT_FOUND)
                  })
            }),
        @ApiResponse(
              ...
              @Content(
                  ...
                  examples = {
                    @ExampleObject(
                        name = EXAMPLE_NOT_FOUND_NAME,
                        description =
                            "A not found response example when trying to delete a doctor does not exist",
                        value = DOCTOR_EXAMPLE_ERROR_404_NOT_FOUND)
                  })
            }),
        @ApiResponse(
              ...
              @Content(
                  ...
                  examples = {
                    @ExampleObject(
                        name = EXAMPLE_INTERNAL_SERVER_ERROR_NAME,
                        description =
                            "A internal server error response example when trying to delete a doctor",
                        value = EXAMPLE_ERROR_500_INTERNAL_SERVER_ERROR)
                  })
            })
      })
  ...
  @Operation(
      ...
      security = @SecurityRequirement(name = AUTHORIZATION),
      description =
          "This endpoint is responsible to retrieve a list of doctors based on the applied filters")
  @ApiResponses(
      value = {
              ...
              @Content(
                  ...
                  examples = {
                    @ExampleObject(
                        name = EXAMPLE_INTERNAL_SERVER_ERROR_NAME,
                        description =
                            "A internal server error response example when trying to retrieve a doctors list",
                        value = EXAMPLE_ERROR_500_INTERNAL_SERVER_ERROR)
                  })
            })
      })
  ...
  public Page<DoctorResponse> listAll(DoctorFilter filter) {
    ...
    var fetchedList = doctors.stream().map(doctorMapper::toDoctorResponse).toList();
